...
class ParseVkBuilderChats extends Command
{
    protected $signature = 'app:vk_parse:builder';

    protected $description = 'Парсинг стен VK для каналов типа «Строитель»';
    ...
    public function handle(ReadVkGroups $readVkGroups): int
    {
        ...
        if (! count($channels)) {
            $this->info('Нет активных VK-источников для типа «Строитель»');
