...
class ParseVkSpecialistChats extends Command
{
    protected $signature = 'app:vk_parse:specialist';

    protected $description = 'Парсинг стен VK для каналов типа «Сотрудник»';
    ...
    public function handle(ReadVkGroups $readVkGroups): int
    {
        ...
        if (! count($channels)) {
            $this->info('Нет активных VK-источников для типа «Сотрудник»');
