...
class SendMessageTelegram
{
    ...
    public function send(string $apiId, string $apiHash, MailingMessage $mailingMessage, Collection $users): bool
    {
        ...
        try {
            $MadelineProto = new API('session.madeline.'.$apiId, $settings);
    ...
    private function releaseMadelineClient(?API &$MadelineProto): void
    {
        ...
        try {
            ...
            Log::channel('mailing_tg')->warning('SendMessageTelegram MadelineProto unset', [
    ...
    private function finalizeMadelineProcess(): void
    {
        try {
            ...
            Log::channel('mailing_tg')->warning('SendMessageTelegram API::finalize', [
                'message' => $e->getMessage(),
            ]);
        }
    }
