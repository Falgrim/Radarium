    ...
    <div class="container-lg p-5 mb-4">
        ...
        <div class="row row-cols-1 row-cols-md-3 mb-3 mt-5 landing_price">
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    <div class="card-header py-3">
                        <h4 class="my-0 fw-normal text-center">1 Месяц</h4>
                    </div>
                    <div class="card-body">
                        <p>Подключайте тариф и пользуетесь им в течении 30 дней.  Доступно 30 объявлений</p>
                        <h3 class="card-title pricing-card-title">3000₽<small class="text-body-secondary fw-light"></small></h3>
            ...
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    <div class="card-header py-3">
                        <h4 class="my-0 fw-normal text-center">Пол года</h4>
                    </div>
                    <div class="card-body">
                        <p>Подключайте тариф и пользуетесь им в течении 180 дней.  Доступно 180 объявлений</p>
                        <h3 class="card-title pricing-card-title">15300 ₽<small class="text-body-secondary fw-light"></small></h3>
                        <button type="button" class="w-100 btn btn-lg btn-outline-primary">Заказать</button>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm border-primary">
                    ...
                    <div class="card-body">
                        <p>Подключайте тариф и пользуетесь им в течении 365 дней.  Доступно 360 объявлений</p>
                        <h3 class="card-title pricing-card-title">28800 ₽<small class="text-body-secondary fw-light"></small></h3>
                        <button type="button" class="w-100 btn btn-lg btn-outline-primary">Заказать</button>
                    </div>
                </div>
            </div>
