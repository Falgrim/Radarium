    ...
    <div class="container-lg p-5 mb-4">
        ...
        <div class="row row-cols-1 row-cols-md-3 mb-3 mt-5 landing_price">
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    <div class="card-header py-3">
                        <h4 class="my-0 fw-normal text-center">Старт</h4>
                    </div>
                    <div class="card-body">
                        <p>Еженедельна подписка по отраслям или на новые объявления</p>
                        <h3 class="card-title pricing-card-title">от 500 ₽<small class="text-body-secondary fw-light">/специализация</small></h3>
                        <h3 class="card-title pricing-card-title">2 000 ₽<small class="text-body-secondary fw-light">/отрасль</small></h3>
            ...
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    <div class="card-header py-3">
                        <h4 class="my-0 fw-normal text-center">Месяц</h4>
                    </div>
                    <div class="card-body">
                        <p>Ежемесячная подписка на новые объявления</p>
                        <h3 class="card-title pricing-card-title">от 1 000 ₽<small class="text-body-secondary fw-light">/специализация</small></h3>
                        <h3 class="card-title pricing-card-title">7 700 ₽<small class="text-body-secondary fw-light">/отрасль</small></h3>
                        <button type="button" class="w-100 btn btn-lg btn-outline-primary">Заказать</button>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm border-primary">
                    <div class="card-header py-3 text-bg-primary border-primary">
                        <h4 class="my-0 fw-normal text-center">Год</h4>
                    </div>
                    <div class="card-body">
                        <p>Ежегодная подписка на новые объявления</p>
                        <h3 class="card-title pricing-card-title">от 10 000 ₽<small class="text-body-secondary fw-light">/специализация</small></h3>
                        <h3 class="card-title pricing-card-title">70 000 ₽<small class="text-body-secondary fw-light">/отрасль</small></h3>
                        <button type="button" class="w-100 btn btn-lg btn-outline-primary">Заказать</button>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm border-warning">
                    <div class="card-header py-3 text-bg-warning border-warning">
                        <h4 class="my-0 fw-normal text-center">Архив</h4>
                    </div>
                    <div class="card-body">
                        <p>Разобрать архив</p>
                        <p>Услуга разобрать архив позволяет разобрать сообщения за любой прошедший период, запрашивается индивидуально</p>
                        <button type="button" class="w-100 btn btn-lg btn-outline-warning">Заказать</button>
                    </div>
                </div>
            </div>
        </div>
