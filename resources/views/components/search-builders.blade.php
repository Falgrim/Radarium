...
<div class="container">
    <div class="row">
        <div class="col">
            <div class="row-flex">
                <h5 class="tab-heading">Строительство</h5>
                <button class="btn btn-link btn-trans btn-trash" type="reset" onclick="window.location.href='{{ route('catalog.builders') }}'">
            ...
            <form class="needs-validation {{ $formErrorClass }}" id="search_form" method="GET" action="{{ route('catalog.builders') }}" novalidate="">
                <div class="search-field">
                    <div class="search-info search-item">
                        <h4>Найдено&nbsp;&nbsp;<span>{{ $authors->total() }}</span></h4>
                        <div class="form-check">
                            <input class="form-check-input" name="open_contacts" value="1" type="checkbox" id="formCheck-builders" @checked(old('open_contacts', $request->open_contacts))>
                            <label class="form-check-label" for="formCheck-builders">Показать только открытые</label>
                        </div>
                        <hr>
                        @if(Auth::check())
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-xl-7">
                                <span class="search-icon">
                                    ...
                                    <input class="form-control" type="text" name="key_word" id="key_word" value="{{ old('key_word', $request->key_word) }}" placeholder="Введите слово и нажмите Enter" title="Введите слово и нажмите Enter">
                                </span>
        ...
        $(document).ready(function() {
            ...
            $('#key_word').on('keypress', function(e) {
                if (e.which === 13) {
                    ...
                    if($('#buttonsContainer .list-group-item').length >= 7) {
                        return false;
                    }
